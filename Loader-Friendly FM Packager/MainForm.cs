...
public sealed partial class MainForm : Form
{
    ...
    {
        get => StoreCreationTimeCheckBox.Checked;
        set
        {
            StoreCreationTimeEnableSettingCheckBox.Checked = value != null;
            StoreCreationTimeCheckBox.Checked = value == true;
        }
    }

    public bool? StoreLastAccessTime
    {
        get => StoreLastAccessTimeCheckBox.Checked;
        set
        {
            StoreLastAccessTimeEnableSettingCheckBox.Checked = value != null;
            StoreLastAccessTimeCheckBox.Checked = value == true;
        }
    }

    public bool? SetArchiveTimeToLatestFileTime
    {
        get => SetArchiveTimeToLatestFileTimeCheckBox.Checked;
        set
        {
            SetArchiveTimeToLatestFileTimeEnableSettingCheckBox.Checked = value != null;
            SetArchiveTimeToLatestFileTimeCheckBox.Checked = value == true;
        }
    }

    public bool DoNotChangeSourceFilesLastAccessTime
    {
        get => DoNotChangeSourceFilesLastAccessTimeCheckBox.Checked;
        set => DoNotChangeSourceFilesLastAccessTimeCheckBox.Checked = value;
    }
    ...
    private void SetArchiveTimeToLatestFileTimeEnableSettingCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        UpdateSetArchiveTimeToLatestFileTime();
    }


    private void StoreCreationTimeCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        UpdateStoreCreationTime();
    }

    private void StoreLastAccessTimeCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        UpdateStoreLastAccessTime();
    }

    private void SetArchiveTimeToLatestFileTimeCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        UpdateSetArchiveTimeToLatestFileTime();
    }

    private void UpdateStoreCreationTime()
    {
        Config.StoreCreationTime =
            !StoreCreationTimeEnableSettingCheckBox.Checked
                ? null
                : StoreCreationTimeCheckBox.Checked;
    }

    private void UpdateStoreLastAccessTime()
    {
        Config.StoreLastAccessTime =
            !StoreLastAccessTimeEnableSettingCheckBox.Checked
                ? null
                : StoreLastAccessTimeCheckBox.Checked;
    }

    private void UpdateSetArchiveTimeToLatestFileTime()
    {
        Config.SetArchiveTimeToLatestTileTime =
            !SetArchiveTimeToLatestFileTimeEnableSettingCheckBox.Checked
                ? null
                : SetArchiveTimeToLatestFileTimeCheckBox.Checked;
    }

    private void DoNotChangeSourceFilesLastAccessTimeCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        Config.DoNotChangeSourceFilesLastAccessTime = DoNotChangeSourceFilesLastAccessTimeCheckBox.Checked;
    }
}
